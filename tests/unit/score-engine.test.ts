...
const account = {
  ...
  country: "UK", city: "London", classification: { primaryCategory: "FAMILY_ATTRACTION_OPERATOR" as const, secondaryCategories: ["LEISURE_ENTERTAINMENT_GROUP"] as ["LEISURE_ENTERTAINMENT_GROUP"], subtypes: [], buyerModel: "OWNER_OPERATOR" as const }, relevanceHypothesis: "A large ticketed attraction with public programming and audience operations.",
